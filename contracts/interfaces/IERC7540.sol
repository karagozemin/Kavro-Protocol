...
/// @dev Kavro keeps this interface as a legacy async vault reference.
///      Current 0G-native flows use commitments and encrypted storage refs instead of public assets.

interface IERC7540Deposit {
    /// @dev Emitted when an async deposit request is submitted.
    ///      assets = 0 for commitment-first confidential vault flows.
    ...
    /// @dev For Kavro flows call submitSealedBid with a bid commitment and encrypted storage ref.
    ...
    ///         Always returns 0 for commitment-first flows.
